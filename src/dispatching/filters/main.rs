...
/// ```
/// use sahke::dispatching::filters::Filter;
///
...
/// ## Examples
/// ```
/// use sahke::dispatching::filters::{And, Filter};
///
...
/// ## Examples
/// ```
/// use sahke::dispatching::filters::{Filter, Or};
///
/// // Note: bool can be treated as `Filter` that always return self.
...
/// ## Examples
/// ```
/// use sahke::dispatching::filters::{or, Filter};
///
...
/// ## Examples
/// ```
/// use sahke::dispatching::filters::{Filter, Not};
///
/// // Note: bool can be treated as `Filter` that always return self.
...
/// ## Examples
/// ```
/// use sahke::dispatching::filters::{not, Filter};
///
...
/// ## Examples
/// ```
/// use sahke::{all, dispatching::filters::Filter};
///
...
/// ## Examples
/// ```
/// use sahke::{any, dispatching::filters::Filter};
///
...
/// ## Examples
/// ```
/// use sahke::dispatching::filters::{f, And, Filter, Or, F};
///
...
pub trait FilterExt<T> {
    ...
    /// ## Examples
    /// ```
    /// use sahke::dispatching::filters::{Filter, FilterExt};
    ///
