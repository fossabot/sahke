...
/// # #[tokio::main]
/// # async fn main_() {
/// use sahke::dispatching::error_handlers::{ErrorHandler, Ignore};
///
...
///
/// use sahke::dispatching::error_handlers::{ErrorHandler, IgnoreSafe};
///
...
///
/// ```compile_fail
/// use sahke::dispatching::dispatchers::filter::error_policy::{
...
/// # #[tokio::main]
/// # async fn main_() {
/// use sahke::dispatching::error_handlers::{ErrorHandler, Print};
///
...
/// # #[tokio::main]
/// # async fn main_() {
/// use sahke::dispatching::error_handlers::ErrorHandler;
///
